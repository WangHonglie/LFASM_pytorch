...
parser.add_argument('--test_dir',default='/home/honglie.whl/datasets/pytorch',type=str, help='./test_data')
parser.add_argument('--name', default='ft_net', type=str, help='save model path')
parser.add_argument('--batchsize', default=16, type=int, help='batchsize')
parser.add_argument('--use_dense', action='store_true', help='use densenet121' )
parser.add_argument('--ms', default='1', help='multiple_scale' )
...
print('-------test-----------')
model_structure = SelfMatchNet(776)
# model_structure = svhnet.STNSVHNet((256,256),3,3,5,num_classes=576)
